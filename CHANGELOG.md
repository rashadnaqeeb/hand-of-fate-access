...
* Combat cues now play through a dedicated audio engine, for harder stereo panning and lower latency.
* The wall collision bump loops when your movement is blocked by a wall.
