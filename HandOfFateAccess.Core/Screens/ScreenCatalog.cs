...
namespace HandOfFateAccess.Screens {
	...
	public static class ScreenCatalog {
		private sealed class Entry {
			// A delegate, not a baked string: the dictionary is built once at class
			// load, and a name read through Strings must follow a language switch.
			public readonly System.Func<string> Name;
			public readonly bool Announce;
			public Entry(System.Func<string> name, bool announce) {
				Name = name;
				Announce = announce;
			}
		}
